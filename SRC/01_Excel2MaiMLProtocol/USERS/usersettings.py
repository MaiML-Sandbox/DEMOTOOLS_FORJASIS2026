...
class defaultNS():
    _MAIML_ATTR = [
    	...
    	'xmlns:KYL="https://www.yasunaga-lab.bio.kyutech.ac.jp/EosJ/index.php/MaiML_NAMESPACE_Definition"', 
...
class filePath():
    ##　ここから編集可
    _IN_EXCEL_FILENAME = "Excel2MaiMLProtocol_Input.xlsx"
    _MaiML_FILENAME = "Excel2MaiMLProtocol_Output.maiml"
    ##　ここまで編集可
